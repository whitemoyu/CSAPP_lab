...
word f_pc = [
	...
	M_icode == IJXX && M_valE <= M_valA && !M_Cnd : M_valA;  # 确定pc，如果 M_valE <= M_valA,说明是M_valA.
...
word aluA = [
	...
	E_icode == IJXX : E_valC;  # pass the valC to Memory
...
word aluB = [
	...
	E_icode ==  IJXX  : 0; # # pass the valC to Memory
	# Other instructions don't need ALU
];
