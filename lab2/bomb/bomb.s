...
00000000004010f4 <phase_6>:
  ...
  40110b:	49 89 e6             	mov    %rsp,%r14     #--------------------  判断数字是否相同
  ...
  401151:	eb c1                	jmp    401114 <phase_6+0x20>  #-----------------------  每个数字 -x+7
  ...
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>  #-----------------把六个节点的地址放到rsp+20，28,30,38,40,48的六个栈空间中。
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx        ##-----------找到第i个节点，i为第n个输入的-n+7
  ...
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx     #--------------重新链接六个节点，顺序为在栈内的顺序。
